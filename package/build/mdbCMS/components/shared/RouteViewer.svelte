<script lang="ts">
    ...
    import Content from "mdbCMS/components/layout/Content.svelte";
    import LeftContent from "mdbCMS/components/layout/LeftContent.svelte";
    import Input from "mdbCMS/components/shared/Input.svelte";
    import TextArea from "mdbCMS/components/shared/TextArea.svelte";
    import Label from "mdbCMS/components/shared/Label.svelte";
    import Button from "mdbCMS/components/shared/Button.svelte";
    import QuestionMark from "mdbCMS/components/shared/QuestionMark.svelte";
    import InputChips from "mdbCMS/components/inputChips/InputChips.svelte";
    import RouteBlocks from "mdbCMS/components/shared/RouteBlocks.svelte";
    import type { RouteLoad, RouteData, ApiRouteCreate, ApiRouteUpdate } from "mdbCMS/types";
