<script lang="ts">
    ...
    import FileSelector from "mdbCMS/components/shared/FileSelector.svelte";
    ...
    import RightContent from "mdbCMS/components/layout/RightContent.svelte";
    import Button from "mdbCMS/components/shared/Button.svelte";
    import Label from "mdbCMS/components/shared/Label.svelte";
    import LabelSelector from "mdbCMS/components/shared/LabelSelector.svelte";
    import Input from "mdbCMS/components/input/Input.svelte";
    import AssetPreview from "mdbCMS/components/shared/AssetPreview.svelte";
    import type { AssetData, UserData, UserLoad } from "mdbCMS/types";
