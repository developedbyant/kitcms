...
export const blockTypeIcons:{[key:string]:any} = {
    input:"🔍",text:"📝",stringList:"📋",number:"🔢",date:"📅",boolean:"✅",json:"📋",file:"📄",files:"📂",linkRoute:"🔗",editor:"📝",slug:"🌎"
}
...
export const blockTypes:RouteBlockTypes[] = ["input","stringList","text","number","date","boolean","file","files","linkRoute","editor","slug"]
