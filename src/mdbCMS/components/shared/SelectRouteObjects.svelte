<script lang="ts">
    ...
    import Chips from "mdbCMS/components/shared/Chips.svelte";
    import LinkedRoute from "mdbCMS/components/shared/LinkedRoute.svelte";
    import type { ApiObjectSearch, ObjectData, RouteBlockData } from "mdbCMS/types";
