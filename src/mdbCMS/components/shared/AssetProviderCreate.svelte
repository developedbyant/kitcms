<script lang="ts">
    ...
    import { assetProvidersTemplate } from "mdbCMS/lib/data";
    ...
    import InPageButtons from "mdbCMS/components/inPageButtons/InPageButtons.svelte";
    import Input from "mdbCMS/components/input/Input.svelte";
    import Button from "mdbCMS/components/shared/Button.svelte";
    import type { AssetProviders,AssetProvidersNames } from "mdbCMS/types";
