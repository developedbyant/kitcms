<script lang="ts">
    ...
    import CheckMarkIcon from "mdbCMS/icons/Check.svelte"
    import type { AssetProvidersNames } from "mdbCMS/types";
    /** Show confirm when user click remove asset provider btn */
    let showConfirm = false
    const dispatch = createEventDispatcher()
    $: active = $page.data.mdbCMS.appData.assetProvider===provider
</script>

<div class="provider">
    <div class="image">
        <img src="/images/providers/{provider}.png" alt={provider}>
