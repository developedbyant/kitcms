<script lang="ts">
    ...
    import Confirm from "mdbCMS/components/shared/Confirm.svelte";
    // icons
    import PlusIcon from "mdbCMS/icons/Plus.svelte";
    import TrashIcon from "mdbCMS/icons/Trash.svelte";
    import PenIcon from "mdbCMS/icons/VectorPen.svelte"
    import XIcon from "mdbCMS/icons/X.svelte";
    import ViewIcon from "mdbCMS/icons/Eye.svelte"
    import CollectionsIcon from "mdbCMS/icons/Collections.svelte";
    import SpinIcon from "mdbCMS/icons/Spin.svelte";
