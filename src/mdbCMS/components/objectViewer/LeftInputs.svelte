<script lang="ts">
    ...
    import Flex from "mdbCMS/components/layout/Flex.svelte";
    ...
    import Editor from "mdbCMS/components/editor/Editor.svelte";
    ...
    import type { AssetData, RouteBlockData } from "mdbCMS/types";
