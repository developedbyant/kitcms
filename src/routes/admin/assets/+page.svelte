<script lang="ts">
    ...
    import Assets from "mdbCMS/components/assets/assets.svelte";
    import FileSelector from "mdbCMS/components/shared/FileSelector.svelte";
    import AssetEditor from "mdbCMS/components/shared/AssetEditor.svelte";
    ...
    import type { AssetData,ApiAssetDelete, ApiAssetUpdate } from "mdbCMS/types";
    $: assets = data.assets
...
{:else}
    ...
    <Pagination basePath="/admin/assets" morePages={assets.length>=data.mdbCMS.appData.assetsPerPage}/>
{/if}