<script lang="ts">
    ...
    import AssetProviderCreate from "mdbCMS/components/shared/AssetProviderCreate.svelte";
    import Label from "mdbCMS/components/shared/Label.svelte";
    import AssetProviders from "mdbCMS/components/assetProviders/AssetProviders.svelte";
    import ConfigForm from "./ConfigForm.svelte";
    import type { PageData } from "./$types";
    import type { ApiAssetProviderDelete, ApiSetAssetProvider, AssetProvidersNames,SettingsData,AssetProviders as AssetProvidersData,ApiAssetProviderSet, ApiSettingUpdate } from "mdbCMS/types";
    let assetProviders = data.assetProviders
    let userData = data.mdbCMS.userData
